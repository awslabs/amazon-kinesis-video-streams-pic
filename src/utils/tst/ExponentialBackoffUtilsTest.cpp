...
{
    EXPECT_EQ(STATUS_NULL_ARG, createExponentialBackoffStateWithDefaultConfig(NULL));

    PExponentialBackoffState pExponentialBackoffState = NULL;
    EXPECT_EQ(STATUS_SUCCESS, createExponentialBackoffStateWithDefaultConfig(&pExponentialBackoffState));
    ...
    EXPECT_EQ(KVS_INFINITE_EXPONENTIAL_RETRIES, pExponentialBackoffState->pExponentialBackoffConfig->maxRetryCount);
...
TEST_F(ExponentialBackoffUtilsTest, testInitializeExponentialBackoffState)
{
    ...
    EXPECT_EQ(STATUS_NULL_ARG, createExponentialBackoffState(NULL, NULL));
    EXPECT_EQ(STATUS_NULL_ARG, createExponentialBackoffState(&pExponentialBackoffState, NULL));
    ...
    EXPECT_EQ(STATUS_NULL_ARG, createExponentialBackoffState(NULL, pExponentialBackoffConfig));
    ...
    EXPECT_EQ(STATUS_SUCCESS, createExponentialBackoffState(&pExponentialBackoffState, pExponentialBackoffConfig));
