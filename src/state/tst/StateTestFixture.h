...
public:
    ...
    UINT32 GetCurrentStateIndex()
    {
        ...
        {
            case TEST_STATE_0: return 0;
            case TEST_STATE_1: return 1;
            case TEST_STATE_2: return 2;
            case TEST_STATE_3: return 3;
            case TEST_STATE_4: return 4;
            case TEST_STATE_5: return 5;
        }
...
protected:
    ...
    STATUS CreateStateMachine()
    {
        ...
        EXPECT_TRUE(STATUS_SUCCEEDED(retStatus = createStateMachine(TEST_STATE_MACHINE_STATES,
