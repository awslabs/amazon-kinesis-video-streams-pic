...
TEST_F(ViewApiTest, createContentView_InvalidInput)
{
    ...
    EXPECT_TRUE(STATUS_FAILED(createContentView(MIN_CONTENT_VIEW_ITEMS, MIN_CONTENT_VIEW_BUFFER_DURATION + 1, NULL, 0, DROP_UNTIL_FRAGMENT_START, &pContentView)));
    EXPECT_TRUE(STATUS_FAILED(createContentView(MIN_CONTENT_VIEW_ITEMS + 1, MIN_CONTENT_VIEW_BUFFER_DURATION, NULL, 0, DROP_UNTIL_FRAGMENT_START, &pContentView)));
    EXPECT_TRUE(STATUS_FAILED(createContentView(MIN_CONTENT_VIEW_ITEMS, MIN_CONTENT_VIEW_BUFFER_DURATION, NULL, 0, DROP_UNTIL_FRAGMENT_START, &pContentView)));
    EXPECT_TRUE(STATUS_FAILED(createContentView(MIN_CONTENT_VIEW_ITEMS + 1, MIN_CONTENT_VIEW_BUFFER_DURATION + 1, NULL, 0, DROP_UNTIL_FRAGMENT_START, NULL)));
}
...
TEST_F(ViewApiTest, freeContentView_NullPointer)
{
    ...
    // Create a valid view
    EXPECT_TRUE(STATUS_SUCCEEDED(createContentView(MIN_CONTENT_VIEW_ITEMS + 1, MIN_CONTENT_VIEW_BUFFER_DURATION + 1, NULL, 0, DROP_UNTIL_FRAGMENT_START, &pContentView)));
