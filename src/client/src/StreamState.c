...
StateMachineState STREAM_STATE_MACHINE_STATES[] = {
    {STREAM_STATE_NEW, STREAM_STATE_NONE | STREAM_STATE_NEW | STREAM_STATE_STOPPED, fromNewStreamState, executeNewStreamState,
     defaultStreamStateTransitionHook, SERVICE_CALL_MAX_RETRY_COUNT, STATUS_INVALID_STREAM_READY_STATE},
    ...
    {STREAM_STATE_PUT_STREAM, STREAM_STATE_READY | STREAM_STATE_PUT_STREAM, fromPutStreamState, executePutStreamState,
     defaultStreamStateTransitionHook, SERVICE_CALL_MAX_RETRY_COUNT, STATUS_PUT_STREAM_CALL_FAILED},
    ...
    {STREAM_STATE_STOPPED,
     ...
     fromStoppedStreamState, executeStoppedStreamState, defaultStreamStateTransitionHook, SERVICE_CALL_MAX_RETRY_COUNT,
